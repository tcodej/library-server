...
-- Dumping data for table assetbin.assets: ~186 rows (approximately)
INSERT INTO `assets` (`id`, `name`, `part_number`, `serial_number`, `notes`, `location_id`, `category_id`, `subcategory_id`, `photo_id`, `storage`, `date_created`, `date_modified`) VALUES
	...
	(196, 'Behringer LM Drum', '', '', 'Ordered 4/22/2025 - Shipped 7/22/2025\n$459, discount 20% for total purchase of $367.20', 3, 6, 33, '4', NULL, '2025-07-27 17:14:46', '2025-07-28 00:52:02');
...
-- Dumping data for table assetbin.subcategories: ~33 rows (approximately)
