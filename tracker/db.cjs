...
const { DB_HOST, DB_USER_TRACKER, DB_PASSWORD_TRACKER, DB_DATABASE_TRACKER } = process.env;

const openConnection = async () => {
	const db = await mysql.createConnection({
		host: DB_HOST,
		user: DB_USER_TRACKER,
		password: DB_PASSWORD_TRACKER,
		database: DB_DATABASE_TRACKER,
...
// this is specific to saving notes, maybe expand to update any fields
